...
class IMGGenerator
{
    public $imagePath = 'E:/phpStudy/PHPTutorial/WWW/printer/images/';//图片存储路径
    public $barcode = '';
    ...
    public function generateQrcode(){
        ...
        $filename = time().'.png';
        $qr = QRcode::png($this->barcode, $filename, 0, 8, 0);
        return $filename;
    ...
    {
        $pngFile  = $this->generateQrcode();
        $resource = imagecreatefrompng($pngFile);
        $bmpName = $this->imagePath.time().'.bmp';
